...
const DropdownAddCheckbox = ({ title, options, selectedOptions, setSelectedOptions }) => {
    ...
    return (
        <div className="relative ">
            <button
                ...
                className="inline-flex justify-between items-center px-4 py-3  w-full rounded-md focus:outline-none focus:border-twilight-100 bg-purple-50  ring-1 ring-inset ring-gray-200  hover:ring-twilight-300 hover:ring-2"
            >
                <span className="text-twilight-500  text-sm">{title}</span>
...
export default DropdownAddCheckbox;

...
export default function FilterJob() {
    ...
    const [selectedJobTypes, setSelectedJobTypes] = useState(
        JSON.parse(localStorage.getItem('selectedJobTypes')) || []
    );

    const [selectedExperienceLevels, setSelectedExperienceLevels] = useState(
        JSON.parse(localStorage.getItem('selectedExperienceLevels'))  || []
    );

    const [selectedPostedTime, setSelectedPostedTime] = useState(
        JSON.parse(localStorage.getItem('selectedPostedTime')) || []
    );

    const [selectedFlexibility, setSelectedFlexibility] = useState(
        JSON.parse(localStorage.getItem('selectedFlexibility')) || []
    );
    ...
    useEffect(() => {
        ...
        localStorage.setItem('selectedExperienceLevels', JSON.stringify(selectedExperienceLevels));
        localStorage.setItem('selectedPostedTime', JSON.stringify(selectedPostedTime));
        localStorage.setItem('selectedFlexibility', JSON.stringify(selectedFlexibility));
        localStorage.setItem('selectedLocation', JSON.stringify(selectedLocation));
        localStorage.setItem('selectedCompany', JSON.stringify(selectedCompany));
        localStorage.setItem('jobs', JSON.stringify(jobs));
        localStorage.setItem('currentPage', JSON.stringify(currentPage));
    }, [selectedJobTypes, selectedExperienceLevels, selectedPostedTime, selectedFlexibility, selectedLocation, selectedCompany, jobs, currentPage]);
    ...
    { label: "Adobe", value: "1480" },
    { label: "Amazon", value: "1586" },
    { label: "Apple", value: "162479" },
    { label: "Centric", value: "2648581" },
    { label: "Cisco", value: "1063" },
    { label: "Continental", value: "3534" },
    { label: "Endava", value: "9707" },
    { label: "Google", value: "1441" },
    { label: "IBM", value: "1009" },
    { label: "Meta Facebook", value: "78833680" },
    { label: "Microsoft", value: "1035" },
    { label: "Netflix", value: "165158" },
    { label: "Oracle", value: "1028" },
    { label: "Salesforce", value: "3185" },
    { label: "Tesla", value: "15564" },
    { label: "Twitter", value: "96622" },
    { label: "Uber", value: "1815218" },
];

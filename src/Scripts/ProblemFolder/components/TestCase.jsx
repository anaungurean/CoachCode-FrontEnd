        ...
        >
          {isLoading ? (
            ...
            <>
              <Play size={18} />
              Run the case
              {isHovered && <span className="ml-2">(Ctrl+Shift)</span>}
            </>
          )}
        </button>
      </div>
        ...
        <ul className="list-disc ml-4">
          {input_variables && input_variables.map((input_variable, index) => (
            <li key={index}>
              <div className="flex items-center mt-2">
                ...
                <span className="inline-flex items-center rounded-md px-2 py-1 ml-2 text-sm font-medium bg-purple-100 text-twilight-400 ring-twilight-500/10 ring-1 ring-inset border-dotted hover:ring-2 shadow-sm">
                  {input_variable.name}
                </span>
          ...
          ))}
          {
            input_variables.length === 0 && (
                <div className="flex items-center mt-2">
                  <p className="text-twilight-400 text-lg font-semibold">Enter the input delimited by &apos;\n&apos; : </p>
                  <input
                    type="text"
                    className="border border-twilight-100 rounded-md p-1 bg-purple-100/10 focus:outline-none focus:border-twilight-400 ml-4"
                    placeholder=" 1 2 3 \n 4 5 6 \n 7 8 9"

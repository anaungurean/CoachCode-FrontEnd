...
export default function SignUpForm() {
  ...
  return (
    <div className="w-90p bg-white px-10 py-20 rounded-3xl border-2 border-twilight-500 shadow-md shadow-twilight-100">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mt-4">
          ...
          <div>
            <label className="text-lg font-medium text-twilight-400">First Name</label>
            <input
              className="w-full border-2 border-twilight-200 rounded-xl p-4 mt-1 bg-twilight-100/10"
              type="text"
              name="firstName"
          ...
          <div>
            <label className="text-lg font-medium text-twilight-400">Second Name</label>
            <input
              className="w-full border-2 border-twilight-200 rounded-xl p-4 mt-1 bg-twilight-100/10"
              type="text"
              name="lastName"

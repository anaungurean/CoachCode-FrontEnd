...
export default function ValidateCodeForm() {
    ...
    return (
        ...
        <h1 className='text-3xl md:text-4xl lg:text-5xl pb-4 font-bold bg-gradient-to-r text-transparent from-twilight-500 to-twilight-100 bg-clip-text'>Validate reset code</h1>
        <p className="font-semibold text-md md:text-lg lg:text-xl text-twilight-300">Please, enter the reset code that you received on mail</p>
        <form onSubmit={handleSubmit}>
            ...
            <div className='flex flex-row justify-center space-x-2 md:space-x-4'>
                ...
                <input
                    ...
                    key={index}
                    type="text"
                    className="w-8 h-8 md:w-12 md:h-12 text-xl md:text-2xl text-center font-semibold border-2 border-twilight-500 rounded-xl bg-violet-50"
                    maxLength={1}
                    value={value}
            ...
            <button className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.02] ease-in-out py-3 rounded-xl bg-gradient-to-r from-twilight-500 to-twilight-100 text-white text-lg font-bold">Validate code</button>
            </div>
